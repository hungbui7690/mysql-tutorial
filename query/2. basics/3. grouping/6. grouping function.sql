/*
- To check whether NULL in the result set represents the subtotals 
or grand totals, you use the GROUPING() function.
- The GROUPING() function returns 1 when NULL occurs in a 
supper-aggregate row, otherwise, it returns 0.
- The GROUPING() function can be used in the select list, 
...
-- The following example shows how to combine the IF() function with 
-- the GROUPING() function to substitute labels for the 
